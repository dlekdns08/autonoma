...
# ── Split modules ─────────────────────────────────────────────────────
#
# The monolith is being split into submodules one cohesive slice at a
# time. Public API is preserved via re-exports below, so consumers
# continue to ``from autonoma.world import Mood`` etc.
#
# Currently extracted:
#   - world/personality.py — Mood, Trait, AgentBones, SPECIES, ...
#   - world/environment.py — TimeOfDay, Season, Weather, WorldClock
#   - world/_events.py     — _fire_event (internal helper)
#
# The remaining classes (Relationship, Memory, Stats, Social, Narrative,
# Quests, Boss, …) still live in this file until they earn their own
# slice. They were kept here because they reference each other and are
...
from autonoma.world.inner_life import (
    DIARY_TEMPLATES,
    DREAM_ITEMS,
    DREAM_TEMPLATES,
    AgentDiary,
